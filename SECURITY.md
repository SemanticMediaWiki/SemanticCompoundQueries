...
Security fixes are provided for the latest major version of Semantic Compound
Queries. Please upgrade to the current release before reporting an issue. Fixes
...
[private vulnerability reporting](https://github.com/SemanticMediaWiki/SemanticCompoundQueries/security/advisories/new).
...
Semantic Compound Queries is an extension to MediaWiki that builds on Semantic
MediaWiki. If the issue is actually in one of those rather than in Semantic
Compound Queries itself, please report it there instead:
