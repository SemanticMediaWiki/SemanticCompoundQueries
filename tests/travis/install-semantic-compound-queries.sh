...
function installToMediaWikiRoot {
	...
	if [ "$SCQ" != "" ]
	then
		composer require 'mediawiki/semantic-compound-queries='$SCQ --update-with-dependencies
	else
		composer init --stability dev
		composer require mediawiki/semantic-compound-queries "dev-master" --dev --update-with-dependencies
